...
// 	// replace x + y with (x + y) to create precedence
...
// 		}
// 		if sub_expr.len > 0 {
// 			sub_val := sub_calc(sub_expr, true)
...
// 		}else {
// 			if idx := expr.index('+') {
// 			println('+ expr:$expr len:$expr.len idx:$idx')
// 			sub_expr = expr[idx - 2..idx + 3]
// 			println(sub_expr)
// 			sub_val := sub_calc(sub_expr, false)
// 			expr = expr.replace(sub_expr, sub_val.str())
// 			println('remaining expr $expr')
// 			continue
// 		}
// 		}
// 		res += sub_calc(expr, true)
// 		break
// 	}
// 	//
// 	return res
